...
-- Tabla favoritos (relación entre usuario y viaje)
...
-- Tabla mis reseñas (reseñas propias del usuario)
CREATE TABLE mis_reseñas (
    id SERIAL PRIMARY KEY,
    id_usuario INT NOT NULL,
    id_viaje INT NOT NULL,
...
-- Tabla reseñas (reseñas generales)
...
-- Tabla mis viajes (relación entre usuario y viaje que ha realizado)
...
INSERT INTO mis_reseñas (id_usuario, id_viaje, valoracion, descripcion) VALUES
...
INSERT INTO reseñas (nombre, apellido, id_viaje, valoracion, descripcion) VALUES
...
-- Ver las reseñas de los usuarios
SELECT * FROM mis_reseñas;

-- Ver las reseñas de los otros usuarios
SELECT * FROM reseñas;

-- Ver los viajes de los usuarios
